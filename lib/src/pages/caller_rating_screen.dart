...
class CallerRatingScreen extends StatefulWidget {
  final String mobileNumber;

  const CallerRatingScreen({Key key, this.mobileNumber}) : super(key: key);
  @override
  _CallerRatingScreenState createState() => _CallerRatingScreenState();
}

class _CallerRatingScreenState extends StateMVC<CallerRatingScreen> {
  RattingController _con;

  _CallerRatingScreenState() : super(RattingController()) {
    _con = controller;
  }
