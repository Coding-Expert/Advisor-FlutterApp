...
class CallerReviewScreen extends StatefulWidget {
  final String mobileNumber;
  final String ratingCategory;

  const CallerReviewScreen({Key key, this.mobileNumber, this.ratingCategory})
      : super(key: key);
  @override
  _CallerReviewScreenState createState() => _CallerReviewScreenState();
}

class _CallerReviewScreenState extends StateMVC<CallerReviewScreen> {
  RattingController _con;

  TextEditingController _commentController = TextEditingController();

  _CallerReviewScreenState() : super(RattingController()) {
    _con = controller;
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            bottom: 10,
            right: config.App(context).appWidth(8),
            child: Ink(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  _makePhoneCall(context, widget.mobileNumber);
                },
              ),
            ),
          )
